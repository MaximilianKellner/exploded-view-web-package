...
export class StatsHandler {
    ...
    async _initialize() {
        ...
        this.fpsStats.dom.style.cssText = 'position:absolute;top:0px;left:calc(50% + -80px);';

        document.body.appendChild(this.fpsStats.dom);

        this.latencyStats = new Stats();
        this.latencyStats.showPanel(1);
        this.latencyStats.dom.style.cssText = 'position:absolute;top:0px;left:50%;'; // Position neben dem FPS-Panel
